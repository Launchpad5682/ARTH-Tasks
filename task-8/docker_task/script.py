    ...
    while True:
        ...
        if option == 1:
            ...
            if(envi == "container"):
                ...
                os.system(f"docker container stop {os_name} >/dev/null 2>&1")
                os.system(f"docker system prune --force >/dev/null 2>&1")
                os.chdir(cd)
        ...
        if(option == 2):
            ...
            if(envi == "container"):
                ...
                print("--------------------------------------")
                os.system("tput setaf 7")
                os.system("docker build -t myrepl:v1 . >/dev/null 2>&1")
